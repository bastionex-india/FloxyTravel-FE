...
const BookingHotelById = () => {
  ...
  const getAllUsers = async () => {
    await axios
      .get(
        `http://http://139.59.82.13:4000/:4000/auth/getbookingdetailbybookingid/${state._id}`,
  ...
  const checkIn = () => {
    ...
    axios({
      method: "post",
      url: `http://http://139.59.82.13:4000/:4000/auth/checkinpermissionbyvendor/${state._id}`,
      headers: {
  ...
  const checkOut = () => {
    axios({
      method: "post",
      url: `http://http://139.59.82.13:4000/:4000/auth/checkoutpermissionbyvendor/${state._id}`,
      headers: {
        Accept: "application/json",
        "Content-Type": "application/json",
      },
