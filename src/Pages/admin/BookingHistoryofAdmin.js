          ...
          <TextWrapper>
            ...
            <TextSelectField>
                ...
                >
                  ...
                  <option value={new Date(new Date().getTime() - (2 * 24 * 60 * 60 * 1000))} >
                  Past Two days
                  </option>
                  <option value={new Date(new Date().getTime() - (7 * 24 * 60 * 60 * 1000))} >
                  Past one week
                  </option>
                  <option value={new Date(new Date().getTime() - (30 * 24 * 60 * 60 * 1000))} >
                  Past one month
                  </option>
